...
> **Narrative frame.** Story-driven, insight-forward. Like walking someone through your thinking, not presenting a deliverable. Lightweight. Surface what mattered: the tension, the decisions, the why, what you learned. Strong hook, clear role and thinking throughout. No need to show every artifact; only what's meaningful.
...
**Cover image:** Single strong visual for the learning platform.

- **Image path:** `/images/case-studies/wizeline/cover-wizeline.png`
- **Alt:** Wizeline Academy learning platform

**Title:** Learning Experience Platform

**Subtitle (hook):** One line that creates tension or curiosity.
...
One paragraph. What it is and why you were there. Human, no jargon.
...
**Headline:** The tension or question you walked in with.

People weren’t finishing. The platform wasn’t built around how people learn.

**Description:** What you found. Concrete, story-friendly.
...
Section title in the app: **How I thought through it.** Each subsection is an insight or a decision point, not a process phase. Short, story-driven. Images only where they add meaning.

### 5.1 The real problem wasn’t the UI
...
**Image:** UX + ID = Learner Experience Design — `Learning-experience.png`

### 5.2 Betting on small steps
...
**Image (optional):** Ideation or structure — one of `ideate-1.png`, `ideate-2.png`, `ideate-3.png`

### 5.3 Motivation without the game
...
### 5.4 One list for everyone meant for no one
...
**Images:** Prototype — `prototype-1.png`, `prototype-2.png`, `Prototype-3.png`

### 5.5 What testing proved
...
**Headline:** The outcome in one sentence.

We shipped a learning experience that people could follow and finish.

**Description:** What changed and what you took away. Human close.
...
**Impact metrics (optional cards):**

| Value | Category | Description |
|-------|----------|-------------|
| 9/10 | NPS | from usability testing |
| 15 | Users | in usability testing before release |
| 3 | Pillars | microlearning, selective gamification, persona-driven IA |

---

## 7. Assets

All assets in `public/images/case-studies/wizeline/`. In the app: `/images/case-studies/wizeline/<filename>`.

| Purpose | Filename | Notes |
|---------|----------|--------|
| Hero / cover | `cover-wizeline.png` | Case study cover |
| The real problem wasn't the UI | `Learning-experience.png` | UX + ID = Learner Experience Design |
| Research / problem framing | `empathize.png`, `define.png` | Optional alternate |
| Ideation | `ideate-1.png`, `ideate-2.png`, `ideate-3.png` | Structure, moodboards, sketches |
| Prototype | `prototype-1.png`, `prototype-2.png`, `Prototype-3.png` | Platform UI and flows |
